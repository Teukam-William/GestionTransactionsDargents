class Transaction
{
    ...
    static numeroTel = document.querySelector(".boiteInfosNumeroTel");
    static montant = document.querySelector(".boiteInfosMontant");
    static operateur = document.getElementsByName("boiteInfosOperateur");
    static depotRetrait = document.getElementsByName("boiteInfosDepotRetrait");
    ...
    static btnDemarrer = document.querySelector(".boiteInfosBtnDemarrer");
    ...
    demarrer()
    {
        ...
        if(numero != ""  && montant != "" && categorie != "" && operateur != "")
        {
            ...
            {
                alert('CE NUMERO N\'EEST PAS CELUI D\'UN OPERATEUR MTN');
            }
